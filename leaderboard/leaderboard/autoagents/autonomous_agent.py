...
class AutonomousAgent(object):
    ...
    def set_global_plan(self, global_plan_gps, global_plan_world_coord):
        ...
        # ds_ids = list(range(len(global_plan_gps)))
        ds_ids = downsample_route(global_plan_world_coord, 2) ## swc added
        self._global_plan_world_coord = [(global_plan_world_coord[x][0], global_plan_world_coord[x][1]) for x in ds_ids]
        self._global_plan = [global_plan_gps[x] for x in ds_ids]
        self._plan_gps_HACK = global_plan_gps

        ds_ids_far = downsample_route(global_plan_world_coord, 50)
        self._global_plan_world_coord_far = [(global_plan_world_coord[x][0], global_plan_world_coord[x][1]) for x in ds_ids_far]
        self._global_plan_far = [global_plan_gps[x] for x in ds_ids_far]
