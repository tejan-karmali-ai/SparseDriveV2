...
class LeaderboardEvaluator(object):
    ...
    def _setup_simulation(self, args):
        ...
        attempts = 0
        num_max_restarts = 1
        print(f"Set num_max_restarts = {num_max_restarts}")
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        try:
            ...
            agent_cfg = args.agent_config + '+' + save_name + '+' + str(args.gpu_rank)
            self.agent_instance.setup(agent_cfg)
            ...
            if not self.sensors:
                ...
                print("*** Comment out validate_sensor_configuration for bev ***")
...
def main():
    ...
    parser.add_argument('--timeout', default=1000.0, type=float,
